    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-green-50">
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-sm text-center">
          <h2 className="text-2xl font-bold text-green-900 mb-4">Enter Admin PIN</h2>
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-green-900">Admin Panel - Total Users: {users.length}</h2>
        <button
          onClick={onLogout}
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-green-100 border-b-2 border-green-300">
                  <th className="px-6 py-3 text-left text-green-900 font-bold">Name</th>
                  <th className="px-6 py-3 text-left text-green-900 font-bold">Prakriti</th>
                  <th className="px-6 py-3 text-left text-green-900 font-bold">Created</th>
                  <th className="px-6 py-3 text-left text-green-900 font-bold">Follow-ups</th>
                  <th className="px-6 py-3 text-center text-green-900 font-bold">Actions</th>
                </tr>
              </thead>
              <tbody>
                {users.map(user => (
                  <tr key={user.id} className="border-b border-green-100 hover:bg-green-50">
                    ...
                    <td className="px-6 py-4">
                      <span className="bg-green-200 px-3 py-1 rounded">{user.prakriti || 'Not analyzed'}</span>
                    </td>
