  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-green-900 mb-8">Personalized Diet for {prakriti}</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-bold text-green-800 mb-4">Foods to Include</h3>
          ...
          <div>
            <h3 className="text-xl font-bold text-green-800 mb-4">Foods to Avoid</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-8 bg-green-50 p-6 rounded-lg">
          <h3 className="font-bold text-green-900 mb-2">Meal Timing</h3>
