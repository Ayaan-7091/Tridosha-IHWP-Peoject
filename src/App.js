      ...
      <nav className="bg-green-900 text-white shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">Tridosha</span>
          </div>
          ...
          {currentUser && (
            <div className="hidden md:flex items-center gap-4">
              ...
              <button onClick={handleLogout} className="flex items-center gap-2 bg-green-800 hover:bg-green-700 px-3 py-2 rounded">
        ...
        {showMenu && currentUser && (
          <div className="md:hidden bg-green-800 px-4 py-3 border-t border-green-700">
            <button onClick={handleLogout} className="w-full flex items-center gap-2 bg-green-700 hover:bg-green-600 px-3 py-2 rounded text-white">
              <LogOut className="w-4 h-4" /> Logout
            </button>
          </div>
        )}
